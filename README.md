...
- Please go to **[GitHub Releases](https://github.com/Hana-ame/EhViewer/releases)** to download the release version

- If the release version has unresolved issues, go to **[GitHub Actions](https://github.com/Hana-ame/EhViewer/actions/workflows/ci.yml?query=branch%3Amaster)** to download the CI version (GitHub account login required)
